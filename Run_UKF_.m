...
parameters (principal moments of inertia)
Inputs: angular velocities ('y_tilde'), applied torques ('FandT').
[Most robot localization algorithms fuse inertial and absolute
measurements to generate state estimates. We assume that pose data
